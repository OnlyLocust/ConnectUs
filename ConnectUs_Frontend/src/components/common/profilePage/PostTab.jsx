...
const PostTab = ({ selectedTab, postLength, bookmarkLength, setSelectedTab }) => {
  ...
  return (
    <div className="flex justify-around mb-10 border-b border-border relative">
      {tabs.map((tab) => (
        <button
          key={tab[0]}
        ...
        >
          ...
          <div
            className={`absolute bottom-0 left-0 right-0 h-0.5 bg-foreground transition-all duration-300 ease-in-out ${
              selectedTab === tab[0]
